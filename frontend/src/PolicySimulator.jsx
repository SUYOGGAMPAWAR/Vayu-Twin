...
export default function PolicySimulator({
  ...
  return (
    <div className="bg-[#111827] border border-slate-800 rounded-xl p-3.5 shadow-sm flex flex-col justify-between h-full">
      <div>
        <div className="flex justify-between items-center mb-2">
          <h3 className="text-xs font-semibold text-white">Policy Scenario Simulator</h3>
          {(trafficReduction > 0 || industrialReduction > 0) && (
            <button onClick={handleReset} className="text-[10px] text-blue-400 hover:text-white underline transition-colors">
              Reset
            </button>
          )}
        </div>
      ...
      <div className="pt-1.5 border-t border-slate-800/80 flex justify-between items-center text-[11px] mt-1">
